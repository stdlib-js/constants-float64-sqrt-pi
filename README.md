...
```javascript
SQRT_PI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-pi@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-sqrt-pi@v0.2.0-umd/browser.js"></script>
```
